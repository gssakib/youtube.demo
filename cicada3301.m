...
%inspecting and matching the columns (COLUMN ELIMINATION)
    ...
    %inspecting and matching the box (BOX EMLIMINATION)   
...
%                             
%                                 for n = 1:3
%                                     if candidates((mem_location + 3*k), n) ~= 0 
%                                         if poten_candidate == candidates((mem_location + 3*k), n)
%                                             match_val = match_val + 1;
%                                         end
%                                            
%                                         
...
%                          for l = 1:(j-1)
%                              for n = 1:3
%                                  if candidates((mem_location - 3*l), n) ~= 0
%                                      if poten_candidate == candidates((mem_location - 3*l), n)
%                                          match_val = match_val + 1;
%                                      end
%                                  end
%                              end
